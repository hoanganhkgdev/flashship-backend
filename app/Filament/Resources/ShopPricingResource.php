    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            Forms\Components\Section::make('Thông tin chung')
                ->description('Loại hàng, phạm vi khu vực và trạng thái áp dụng')
            ...
            Forms\Components\Section::make('Bảng giá theo km')
                ->description('Sắp xếp các ngưỡng quãng đường từ nhỏ đến lớn')
            ...
            Forms\Components\Section::make('Phụ phí')
                ->description('Chi phí phát sinh khi vượt quãng đường hoặc trọng lượng quy định')
