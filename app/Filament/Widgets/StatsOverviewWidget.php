...
class StatsOverviewWidget extends Widget
{
    ...
    protected function getViewData(): array
    {
        ...
        $pendingOrders = (clone $orderBase)->whereIn('status', ['pending', 'assigned', 'processing'])->whereDate('created_at', $today)->count();
        $cancelledOrders = (clone $orderBase)->where('status', 'cancelled')->whereDate('created_at', $today)->count();
        ...
        return compact('totalOrders', 'completedOrders', 'pendingOrders', 'cancelledOrders', 'driversOnline', 'revenue', 'completionRate', 'cityName');
    }
}
